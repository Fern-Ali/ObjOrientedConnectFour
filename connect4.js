...
/*ADDING CUTE SKIN FOR CONNECT 4 GAME*/
...
class Game {
    ...
    this.handleGameClick = this.handleClick.bind(this);   /*binding this to handleGameClick so the obj is always game*/
    ...
    for (let x = 0; x < this.width; x++) {
        const headCell = document.createElement('td');
        headCell.setAttribute('id', x);
        headCell.classList.add("myTopCells");
        top.append(headCell);
    }
